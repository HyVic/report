<template>
  <el-scrollbar height="100%">
    <p><i class="iconfont icon-liebiao"></i>数据服务类别介绍</p>
    <div class="introduce">
      <div class="introduce_left">
        <div class="introduce_title">标题</div>
        <div class="introduce_desc">介绍</div>
      </div>
      <div class="introduce_right">
        <div class="introduce_title">
          技术服务<span @click="handleEditi"><i class="iconfont icon-bianji"></i>{{ texti }}</span>
        </div>
        <editor-page :type="'edit'" :is-edit="isEditi"></editor-page>
      </div>
    </div>
    <p><i class="iconfont icon-liebiao"></i>数据服务列表</p>
