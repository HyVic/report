    ...
    <div class="pagination">
      ...
      <div class="pagination_inner">
            <div v-if="show" class="page_count">
                <div class="page_count_text">第&nbsp;{{ pageNum }}&nbsp;页，共&nbsp;{{ totalPage }}&nbsp;页（共&nbsp;{{ total }}&nbsp;项）</div>
      <!--           <DxSelectBox
                    placeholder=""
                    v-model:value="pageSize"
                    :items="changePageSize"
                    @ItemClick="onValueChanged"/> -->
                <el-select v-model="pageSize" placeholder="Select" @change="onValueChanged">
                    <el-option
                        v-for="item in changePageSize"
                        :key="item.value"
                        :label="item.label"
                        :value="item.value"
                    />
