<template>
  <div class="service_introduce">
    <div class="service_introduce_left">
      ...
      <div class="service_introduce_desc">详情</div>
    </div>
    <div class="service_introduce_right">
      <div class="service_introduce_title">
        <input type="text" v-model="titleValue" :disabled="!isEdit"><span @click="handleEdit"><i class="iconfont icon-bianji"></i>{{ text }}</span>
      </div>
      <editor-page :type="'edit'" :is-edit="isEdit" :cont="valueHtml"></editor-page>
    </div>
  </div>
</template>
...
.service_introduce {
  ...
  display: flex;
  .service_introduce_left {
    width: 299px;
    border-right: 1px solid #dfdfdf;
    .service_introduce_desc {
